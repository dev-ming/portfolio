      ...
      <section className="py-12 md:py-20 px-4 md:px-6 relative pt-24 md:pt-32">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center space-y-6 md:space-y-8">
            ...
            <div className="space-y-4 font-light md:space-y-6 text-sm md:text-[18px] text-gray-800 text-center break-keep leading-relaxed md:leading-[29.25px] max-w-3xl mx-auto">
              <p>
